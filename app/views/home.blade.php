                  ...
                  <div class="body-content">
                    ...
                    <div class="row">
                      <div class="col-md-3 text-center">
                        <img src="assets/images/Grace.jpg" alt="avatar" class="img-responsive img-profile img-circle">
                      </div>
                      <div class="col-md-9">
                        <div class="mini-desc">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="identity-area">
                          <div class="row">
                            ...
                            <div class="col-sm-8"> Grace Faubion </div>
                          </div>
                          <div class="row">
                            <div class="col-sm-4"><label>Date of birth</label></div>
                            <div class="col-sm-8"> October 2, 1987</div>
                          </div>
                        <!--   <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-8"> 214-223-6190 </div>
                          </div>
                          <div class="row">
                            <div class="col-sm-4"><label>Email</label></div>
                            <div class="col-sm-8">gdfaubion@gmail.com</div>
                          </div>
                         <!--  <div class="row">
                      ...
                      <div class="col-md-6">
                        <h3 class="title with-icon"><i class="fa fa-bell-o icn-title"></i> Skills</h3>
                        <div class="box-block">
                          <ul class="list-unstyled list-strip">
                            <li><i class="fa fa-check"></i>Linux, Apache, MYSQL, PHP</li>
                            <li><i class="fa fa-check"></i>JavaScript and jQuery</li>
                            <li><i class="fa fa-check"></i>Laravel Framework</li>
                            <li><i class="fa fa-check"></i>HTML5 and CSS3</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <h3 class="title with-icon"><i class="fa fa-check-square-o icn-title"></i>My Life Outside of Web Development</h3>
                        <div class="box-fact-area">
                          <div class="row">
                            <div class="col-sm-4">
                              <div class="box-fact">
                                <img style="width:190px" src="/assets/images/dogs2.jpg">
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="box-fact">
                                <img style="width:190px" src="/assets/images/meandjess.jpg">
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="box-fact">
                                <img style="width:190px" src="/assets/images/dogs.jpg">
                              </div>
                            </div>
<!--                             <div class="col-sm-3">
                              <div class="box-fact">
                                <img style="width:180px" src="/assets/images/meandkids.jpg">
                              </div>
                            </div> -->
                          </div>
                        </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="box-block">
                          <ul class="list-unstyled list-clients clearfix">
                            <li><a href="#"><img src="assets/images/client/client.png"  alt="" class="img-responsive"></a></li>
                            <li><a href="#"><img src="assets/images/client/client.png" alt="" class="img-responsive"></a></li>
                            <li><a href="#"><img src="assets/images/client/client.png" alt="" class="img-responsive"></a></li>
                            <li><a href="#"><img src="assets/images/client/client.png" alt="" class="img-responsive"></a></li>
                          </ul>
                  ...
                  <div class="body-content">
                    <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="box-block">
                          <div class="time-line">
                            ...
                            <div class="item-event">
                              ...
                              <div class="event-content">
                                <h4>Bartender</h4>
                                <h5>Fish City Grill</h5>
                                <p>I started with Fish City Grill in 2011 as a waitress, but quickly grew within the company. I took on a role as trainer for new serving employees. I then went through training to become a bartender and loved the new experience I had interacting with customers. i was then given the promotion to key holder where I was trusted to have privileges such as completing nightly paperwork, ensuring all staff were doing their jobs safely and correctly, and ensuring customer satisfaction. </p>
                              </div>
                            </div>
                            <div class="item-event">
                              ...
                              <div class="event-content">
                                ...
                                <h5>American Eagle Outfitters</h5>
                        ...
                        ===================================-->
                        <div class="deviter"></div>
                        <h3 class="title with-icon"><span class="fa fa-book icn-title"></span> Education and Training</h3>
                        <div class="box-block">
                          <div class="time-line">
                            <div class="item-event current">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="box-block">
                          ...
                          <ul class="list-unstyled list-skills">
                            <li>
                              <span class="caption-skill">Laravel Framework</span>
                              <div class="progress">
...
<!--                         </div>
 ...
 <!--                          <ul class="list-unstyled list-points-progress">
                        ...
                        <div class="deviter"></div>
                        <h3 class="title with-icon"><span class="fa fa-file icn-title"></span> Download My Resume</h3>
                        <div class="box-block">
                          <p>You can download my Resume in pdf format if you like.</p>
                          <a href="/assets/GraceResume.pdf" download="GraceFaubionResume" class="btn btn-flat btn-block"><i class="fa fa-download"></i> Download</a>
                        </div>
                      </div>
                    </div>
